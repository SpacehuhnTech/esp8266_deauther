...
const char W_INDEX_HTML[] PROGMEM = "index.html";
const char W_PWNED[] PROGMEM = "pwned";
const char W_DEAUTHER[] PROGMEM = "deauth.me";
const char W_WEBINTERFACE[] PROGMEM = "/web";
const char W_DOWNLOAD[] PROGMEM = "download";
const char W_CONTENT_ENCODING[] PROGMEM = "Content-Encoding";
const char W_CACHE_CONTROL[] PROGMEM = "Cache-Control";
const char W_STREAM[] PROGMEM = "application/octet-stream";
...
const char W_EDIT[] PROGMEM = "/edit";
const char W_BAD_ARGS[] PROGMEM = "BAD ARGS";
const char W_BAD_PATH[] PROGMEM = "BAD PATH";
const char W_FILE_NOT_FOUND[] PROGMEM = "FileNotFound";
const char W_OFF[] PROGMEM = "off";
const char W_STARTED_AP[] PROGMEM = "Started AP";
const char W_LIST[] PROGMEM = "/list";
const char W_RUN[] PROGMEM = "/run";
const char W_DEFAULT_LANG[] PROGMEM = "/lang/default.lang";
const char W_CMD[] PROGMEM = "cmd";
const char W_DIR[] PROGMEM = "dir";
